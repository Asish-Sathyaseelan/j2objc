...
public class LogSiteInjectorTest extends GenerationTest {
  ...
  public void testInjectEnclosingClass() throws IOException {
    options.setInjectLogSites(true);
    String source =
        String.join(
            "\n",
            ...
            "  }",
            "}");
    String translation = translateSourceFile(source, "test.HelloFlogger", "test/HelloFlogger.m");
    assertTranslation(
        translation,
  ...
  // Verify log messages have correct class name for inner classes.
